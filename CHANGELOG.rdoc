=== 1.9.3 (29th Jan 2024)
* replace exists? with exist? for Ruby 3.2+ compatibility. | [@pavel](https://git.easy.cz/pavel)
...
=== 1.9.1 (11nd Fabruary 2022)

* rspec version conflict -> remove development_dependencies. | [@lukas](https://git.easy.cz/lukas)
